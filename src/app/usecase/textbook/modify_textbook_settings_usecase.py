...
class ModifyTextbookSettingsUsecase(TextbookUsecaseBase[ModifyTextbookSettingsDependencies]):
    def exec(self, modify_textbook_settings_dto: ModifyTextbookSettingsDTO) -> None:
        with self._session.begin():
            ...
            textbook_settings = self._dependencies.settings.get(textbook_id=modify_textbook_settings_dto.textbook_id)
